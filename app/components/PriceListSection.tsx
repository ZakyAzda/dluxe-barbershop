...
const PRICE_TIERS = [
  {
    ...
    items: [
      { name: "Potong Rambut",         price: "Rp 40.000" },
      { name: "Potong + Cuci Rambut",  price: "Rp 55.000" },
      { name: "Cukur Jenggot",         price: "Rp 25.000" },
      { name: "Rapiin Alis",           price: "Rp 15.000" },
    ],
    /* Price shown in WA message = starting from */
    displayPrice: "Mulai Rp 15.000",
  },
  {
    id:      "premium",
    badge:   "Terpopuler",
    ...
    items: [
      { name: "Potong + Styling",           price: "Rp 65.000"  },
      { name: "Potong + Cuci + Styling",    price: "Rp 80.000"  },
      { name: "Cukur Jenggot + Treatment",  price: "Rp 45.000"  },
      { name: "Creambath / Hair Mask",      price: "Rp 65.000"  },
      { name: "Hair Coloring",              price: "Rp 120.000" },
    ],
